...
<div class="card" style="max-width: 700px;">
    <div class="card-header">Tambah Opsi Jawaban</div>
    <div class="card-body">
        <form action="{{ route('admin.options.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <label for="label" class="form-label">Label (A/B/C/...)</label>
                    <input type="text" class="form-control @error('label') is-invalid @enderror" id="label" name="label" value="{{ old('label') }}" maxlength="1" required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('option_text') is-invalid @enderror" id="option_text" name="option_text" rows="2" required>{{ old('option_text') }}</textarea>
